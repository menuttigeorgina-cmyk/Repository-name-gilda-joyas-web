...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#FBF7F0] text-[#2B2B2B]">
      ...
      <section className="grid items-center gap-8 px-6 pb-10 pt-8 md:grid-cols-[0.9fr_1.1fr] md:px-8 lg:gap-10 lg:pl-10 lg:pr-0">
        ...
        <div className="relative lg:justify-self-end lg:w-full">
          <div className="relative h-[300px] overflow-hidden rounded-[1.5rem] border-2 border-[#BFAE9E] shadow-[0_10px_30px_rgba(0,0,0,0.05)] sm:h-[340px] md:h-[420px] lg:h-[560px] lg:rounded-l-[2rem] lg:rounded-r-none">
            <img
