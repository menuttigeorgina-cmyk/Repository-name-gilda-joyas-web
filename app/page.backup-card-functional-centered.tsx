                ...
                <div className="mt-3 flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="flex h-9 w-9 items-center justify-center rounded-full border border-[#D8C6B7] text-[#2B2B2B] transition hover:bg-[#E9DDD2]"
                    >
                      ♡
                    </button>
                    ...
                    <button
                      ...
                      className="rounded-[4px] border border-[#2B2B2B] px-4 py-2 text-[12px] font-medium text-[#2B2B2B] transition hover:bg-[#2B2B2B] hover:text-white"
                    >
                      Agregar
                    </button>
                  </div>
