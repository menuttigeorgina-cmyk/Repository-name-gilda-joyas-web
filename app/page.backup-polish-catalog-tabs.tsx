    ...
    <main className="min-h-screen bg-[#FBF7F0] text-[#2B2B2B]">
      <header className="sticky top-0 z-50 border-b border-[#E8DED5] bg-[#FAF6F2]/95 backdrop-blur-md">
        <div className="mx-auto grid max-w-7xl grid-cols-3 items-center px-6 py-3 md:px-10">
          ...
          <div className="flex items-center justify-end gap-4 text-[#2B2B2B]">
            ...
            <button aria-label="Carrito" className="relative rounded-full p-2 transition hover:bg-white focus:outline-none focus:ring-0">
              <svg width="23" height="23" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
      ...
      <section id="productos" className="mx-auto max-w-7xl px-6 py-16 md:px-10">
        ...
        <div className="mb-10 flex flex-wrap justify-center gap-x-14 gap-y-5 border-y border-[#E5DAD1] py-7">
        ...
        <div className="mb-12 flex flex-wrap justify-center gap-x-9 gap-y-4">
          {typeFilters.map((filter) => (
            <button
              ...
              className={`text-sm transition ${
                activeType === filter
                  ? "font-semibold text-[#9C7F6C]"
                  : "font-normal text-[#7B7068] hover:text-[#2B2B2B]"
              }`}
            >
              {filter}
            </button>
