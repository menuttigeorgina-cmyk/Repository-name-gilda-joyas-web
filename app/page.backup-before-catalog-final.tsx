      ...
      <section id="productos" className="mx-auto max-w-7xl px-6 py-16 md:px-10">
        <div className="mb-10 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          ...
          <p className="max-w-md text-sm leading-6 text-[#6b625d]">
            Explorá las piezas por material y tipo de joya. Una selección simple, moderna y pensada para todos los días.
          </p>
        </div>

        <div className="mx-auto mb-5 flex max-w-4xl flex-wrap justify-center gap-3">
          {materialFilters.map((filter) => (
            <button
              ...
              className={`min-w-[150px] rounded-[4px] border px-5 py-3 text-sm transition ${
                activeCategory === filter
                  ? "border-[#2B2B2B] bg-[#2B2B2B] text-white"
                  : "border-[#C8B6A8] bg-transparent text-[#5f5550] hover:border-[#2B2B2B]"
              }`}
            >
              {filter}
            </button>
        ...
        <div className="mx-auto mb-10 flex max-w-5xl flex-wrap justify-center gap-3 border-t border-[#E5DAD1] pt-6">
            ...
            <button
              ...
              className={`rounded-full px-4 py-2 text-sm transition ${
                activeType === filter
                  ...
                  : "text-[#8A7E76] hover:bg-[#EFE7DE] hover:text-[#2B2B2B]"
              }`}
            >
              {filter}
            </button>
            ...
            {filteredProducts.map((product) => (
              <article key={product.id} className="group bg-transparent">
                ...
                <div className="mt-3 flex items-end justify-between gap-4">
                  <strong className="text-[15px] font-medium">$ {product.price}</strong>
                  <button
