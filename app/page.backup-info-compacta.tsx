      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto mb-10 max-w-3xl text-center">
            ...
            <h2 className="mt-3 font-serif text-4xl md:text-5xl">
              Materiales, pagos y cuidados
            </h2>
            <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-[#D8CFC8]">
              Información real de GILDA Joyas para comprar con más confianza:
              pagos, envíos, cambios, packaging y recomendaciones de cuidado.
            </p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <article className="border border-white/15 bg-white/5 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-[#D8CFC8]">
                Aceptamos efectivo, transferencia bancaria, billeteras virtuales,
                tarjeta de débito y tarjeta de crédito en cuotas.
              </p>
              <p className="mt-3 text-sm leading-6 text-[#D8CFC8]">
                Abonando en efectivo o por transferencia tenés un 15% de descuento.
              </p>
            </article>
            ...
            <article className="border border-white/15 bg-white/5 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-[#D8CFC8]">
                Realizamos envíos a domicilio en Santa Fe Capital y alrededores,
                previa coordinación. El costo puede variar según la zona.
              </p>
              <p className="mt-3 text-sm leading-6 text-[#D8CFC8]">
                También hacemos envíos por Correo Argentino al resto del país.
              </p>
            </article>
            ...
            <article className="border border-white/15 bg-white/5 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-[#D8CFC8]">
                No se aceptan cambios una vez pasadas las 24 horas desde la recepción
                del producto. Los cambios solo se realizan por fallas en el material.
              </p>
              <p className="mt-3 text-sm leading-6 text-[#D8CFC8]">
                Por motivos de higiene, aros, argollas y piercings no tienen cambio,
                salvo que presenten una falla.
              </p>
            </article>
            ...
            <article className="border border-white/15 bg-white/5 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-[#D8CFC8]">
                Trabajamos con plata 925, acero quirúrgico, acero blanco, acero dorado
                y piezas artesanales. El acero quirúrgico es inalterable y de alta
                durabilidad.
              </p>
              <p className="mt-3 text-sm leading-6 text-[#D8CFC8]">
                La elección del material depende de cada piel: cada persona puede
                adaptarse mejor a un material distinto.
              </p>
            </article>

            <article className="border border-white/15 bg-white/5 p-5">
              <h3 className="text-lg font-semibold">Cuidados</h3>
              <p className="mt-3 text-sm leading-6 text-[#D8CFC8]">
                Recomendamos evitar el contacto con perfumes, transpiración, jabones,
                productos de limpieza, cosméticos, químicos o sustancias corrosivas.
              </p>
              <p className="mt-3 text-sm leading-6 text-[#D8CFC8]">
                La plata puede oscurecerse según el pH de la piel, pero con una limpieza
                adecuada puede recuperar su brillo y color original.
              </p>
            </article>

            <article className="border border-white/15 bg-white/5 p-5">
              <h3 className="text-lg font-semibold">Packaging para regalo</h3>
              <p className="mt-3 text-sm leading-6 text-[#D8CFC8]">
                Si la compra es para regalo, preparamos un packaging especial.
                Puede incluir bolsita, cajita o sobre, según el tipo de producto.
              </p>
              <p className="mt-3 text-sm leading-6 text-[#D8CFC8]">
                Las piezas bañadas en plata rose o plata gold deben cuidarse especialmente:
                no son aptas para bañarse, hacer deporte o ir al gimnasio.
              </p>
            </article>
          </div>
        </div>
