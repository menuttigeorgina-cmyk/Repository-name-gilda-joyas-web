    ...
    <main className="min-h-screen overflow-x-hidden bg-[#FBF7F0] text-[#2B2B2B]">
      <header className="sticky top-0 z-50 border-b border-[#E8DED5] bg-[#FAF6F2]/95 backdrop-blur-md">
        <div className="mx-auto grid max-w-7xl grid-cols-3 items-center px-6 py-3 md:px-10">
          <nav className="hidden items-center gap-8 text-[15px] font-normal text-[#2B2B2B] lg:flex">
          ...
          <div className="flex items-center justify-end gap-3 text-[#2B2B2B] md:gap-5">
            <button
              ...
              className="hidden text-[15px] font-normal lg:inline"
            >
              Cuenta
            </button>
      ...
      <section className="grid items-center gap-10 px-6 pb-12 pt-8 md:px-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-10 lg:pl-10 lg:pr-0">
        ...
        <div className="relative lg:justify-self-end lg:w-full">
          <div className="relative h-[320px] overflow-hidden rounded-[1.5rem] border-2 border-[#BFAE9E] shadow-[0_10px_30px_rgba(0,0,0,0.05)] sm:h-[380px] md:h-[430px] lg:h-[560px] lg:rounded-l-[2rem] lg:rounded-r-none">
            <img
